...
【优化】工单处理页面去除“所有任务”和“评论”
【修复】API配置“请求数据加工”无法使用json问题
【修复】“所有单据”的“服务”列表未显示数据问题

## [Version: 2.7.12] - 2025-08-05
【新增】日语适配  
【修复】XSS安全漏洞  
【修复】修复转单操作请求用户接口的权限问题

## [Version: 2.7.11] - 2025-07-14
【修复】修复自动审批和快速审批冲突导致卡单的问题  
【新增】根据单据ID获取单据信息的APIGW接口  
【修复】修复越权问题
...
【新增】使用环境变量配置是否启用蓝盾节点  
【新增】获取单据日志的`get_ticket_event_logs`接口  
【新增】获取单据当前审批人`get_tickets_processors`apigw接口  
【优化】错误消息提示显示不全  
【修复】单据列表页面获取"当前处理人"接口报错的问题  
【修复】标准运维节点日志接口报错问题  
【修复】API提单时不传有默认值的必填字段会报错的问题
【修复】蓝盾节点打开无法回填已选择流水线

## [Version: 2.7.5] - 2025-03-04
【优化】优化OpenAPI创建提单时如果传入多余字段会报错的问题  
【修复】修复提单页不展示自定义表单字段的问题  
【优化】优化标准运维节点保存时的验证逻辑  
【新增】审批节点新增已审批通过的审批人自动通过配置选项  

## [Version: 2.7.4] - 2025-02-18
【优化】移除链接字段旁边的预览入口  
【修复】修复单据详情页接口重复调用问题  
【修复】修复线条配置条件关系表单字段校验问题  
【修复】修复工单详情页评论接口中的XSS漏洞，增加了对`a`标签的过滤  
【优化】优化分支网关条件包含关系判断逻辑  
