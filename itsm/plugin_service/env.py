...
PLUGIN_SERVICE_APIGW_APP_CODE = os.getenv(
    "BKAPP_PLUGIN_SERVICE_APIGW_APP_CODE", settings.APP_CODE
)
PLUGIN_SERVICE_APIGW_APP_SECRET = os.getenv(
    "BKAPP_PLUGIN_SERVICE_APIGW_APP_SECRET", settings.APP_TOKEN
)
...
PLUGIN_DISTRIBUTOR_NAME = getattr(
    settings, "PLUGIN_DISTRIBUTOR_NAME", PLUGIN_SERVICE_APIGW_APP_CODE
)
