    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that openid already exists.'},
                ...
                ('nickname', models.CharField(blank=True, help_text='Required. 64 characters or fewer.', max_length=64,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('key',
                 models.CharField(help_text='Required. 64 characters or fewer. Letters, digits and underlined only.',
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='properties',
    ...
    def apply(self, project_state, schema_editor, collect_sql=False):
        with connection.cursor() as cursor:
            ...
            if 'account_user' in rows:
                print('account_user exists, skip create operations.')
