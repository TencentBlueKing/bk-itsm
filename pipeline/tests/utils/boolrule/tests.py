...
class BoolRuleTests(TestCase):
    ...
    def test_issuperset_single(self):
        self.assertFalse(BoolRule(' ("3") issuperset ("1")').test())
        self.assertTrue(BoolRule(' ("1") issuperset ("1") ').test())

    def test_issuperset_multi(self):
        self.assertTrue(BoolRule(' ("1", "2") issuperset ("1", "2") ').test())
        self.assertFalse(BoolRule(' ("3", "2") issuperset ("1") ').test())
