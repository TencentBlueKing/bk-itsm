...
def get_transtable(mod):
    return {
        ...
        "newCommon": {
            ...
            "确认催办该节点": "Confirm to supervise the node",
            "执行催办操作后，将发送信息至处理人": "After executing the supervisory operation, the message will be sent to the processor.",
            "撤单成功": "Revoked successfully",
            "领取成功": "Took successfully",
            "催办成功": "Supervised successfully",
        },
        "serviceConfig": {
            "服务名称": "Service Name",
        ...
        "treeinfo": {
            ...
            "是否通知：": "Notify:",
            "是否催办：": "Supervise:",
            "默认催办人：提单人": "Default supervisor: Submitter",
            "其他催办人：": "Other supervisors:",
